...
install -t /usr/share/licenses/dkms -Dm644 dkms-3.0.6/COPYING
rm -rf dkms-3.0.6
# GLib.
...
# x265.
tar -xf x265-3.5-37-g9b59d4554.tar.xz
cd x265-3.5-37-g9b59d4554
