...
- libzip: `1.9.2 --> 1.11.4`
- Linux: `6.0.0 --> 6.19.0`
- Linux-API-Headers: `6.0.0 --> 6.19.0`
- Linux-Firmware: `(new package) --> 20260110`
- Linux-Headers: `6.0.0 --> 6.19.0`
...
- pyproject-metadata: `(new package) --> 0.10.0`
...
- qemu-guest-agent: `(new package) --> 10.2.0`
- Qpdf: `11.1.1 --> 12.3.2`
- rav1e: `0.5.1 --> 0.8.1`
