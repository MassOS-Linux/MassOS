...
- Changed minimum supported kernel version in Glibc from 3.2 to 5.10, to improve optimization.
...
- Removed `adduser` utility from the system (the recommended way to create users is with `useradd` - see `man 8 useradd` for details).
...
- Replaced p7zip with newer 7zip package.
...
- Added HTTP/3 support in curl using libnghttp3 and libngtcp2.
...
- 7zip: `(new package) --> 26.01`
- a52dec: `0.7.4 --> 0.8.0`
- AccountsService: `22.08.8 --> 26.27.3`
- Acl: `2.3.1 --> 2.4.0`
- acpid: `(new package) --> 2.0.34`
- adwaita-icon-theme: `43 --> 50.0`
- alsa-lib: `1.2.7.2 --> 1.2.16`
...
- appstream-glib: `0.8.0 --> 0.8.4`
- aria2: `(new package) --> 1.37.0-42-g9e727358`
- Asciidoc: `10.2.0 --> 10.2.1`
- asciidoctor: `(new package) --> 2.0.26`
- Aspell: `0.60.8 --> 0.60.8.2`
- at-spi2-core: `2.46.0 --> 2.60.6`
- Atkmm: `2.28.3 --> 2.28.5`
- Attr: `2.5.1 --> 2.6.0`
- Audit: `3.0.9 --> 4.0.3`
- Autoconf: `2.71 --> 2.73`
...
- brotli: `1.0.9 --> 1.2.0`
- bsd-games: `3.2 --> 3.3`
- btrfs-progs: `5.19.1 --> 7.1`
- Bubblewrap: `0.6.2 --> 0.11.2`
- build: `(new package) --> 1.5.1`
- Busybox: `1.35.0 --> 1.38.0`
- c-ares: `1.18.1 --> 1.34.8`
- cabextract: `(new package) --> 1.11`
- Cairo: `1.17.6 --> 1.18.4`
- Cairomm: `1.14.4 --> 1.14.6`
...
- elfutils: `0.187 --> 0.195`
- Enchant: `2.3.3 --> 2.8.19`
...
- FAAC: `(new package) --> 1.50`
- FAAD2: `2.10.0 --> 2.11.2`
- Fakeroot: `1.29 --> 1.38.1`
...
- Findutils: `4.9.0 --> 4.11.0`
- firewalld: `(new package) --> 2.3.0`
- fish: `(new package) --> 4.0.2`
- FLAC: `1.4.1 --> 1.5.0`
- flashrom: `1.2 --> 1.7.0`
- Flatpak: `1.14.0 --> 1.18.0`
- flit-core: `(new package) --> 4.0.2`
- fmt: `9.1.0 --> 12.2.0`
- font-util: `1.3.3 --> 1.4.2`
- Fontconfig: `2.14.0 --> 2.18.3`
- FreeGLUT: `3.2.2 --> 3.8.0`
- FreeType: `2.12.1 --> 2.14.3`
...
- GDBM: `1.23 --> 1.25`
- GDK-Pixbuf: `2.42.9 --> 2.44.7`
- GeoClue: `2.6.0 --> 2.8.2`
- Gettext: `0.21 --> 0.26`
- gexiv2: `0.14.0 --> 0.16.2`
- GhostScript: `10.0.0 --> 10.07.0`
- gi-docgen: `2022.1 --> 2026.1`
- giflib: `5.2.1 --> 6.1.3`
- Git: `2.38.0 --> 2.55.0`
...
- glslang: `11.11.0 --> 16.5.0`
- GLU: `9.0.2 --> 9.0.3`
- glycin: `(new package) --> 2.1.5`
- GMP: `6.2.1 --> 6.3.0`
- gnome-common: `(new package) --> 3.18.0`
- gnome-keyring: `42.1 --> 48.0`
- gnome-online-accounts: `3.46.0 --> 3.58.1`
- GNU-EFI: `3.0.15 --> 4.0.4`
- GNUPG: `2.3.7 --> 2.5.21`
- GNUTLS: `3.7.8 --> 3.8.13`
- gobject-introspection: `1.74.0 --> 1.86.0`
- gperf: `3.1 --> 3.3`
- GPGME: `1.18.0 --> 2.1.2`
- gpgmepp: `(new package) --> 2.1.0`
- gpgmepy: `(new package) --> 2.0.0`
- gptfdisk: `1.0.9 --> 1.0.10`
- Graphite2: `1.3.14 --> 1.3.14-121-g142e1bda`
- Graphviz: `6.0.1 --> 15.1.1`
- Grep: `3.8 --> 3.12`
- Groff: `1.22.4 --> 1.24.1`
- GRUB: `2.06 --> 2.14`
...
- Inetutils: `2.3 --> 2.8`
- inih: `56 --> 62`
- installer: `(new package) --> 1.0.0`
- intel-gmmlib: `(new package) --> 22.10.0`
- intel-media-driver: `(new package) --> 26.2.4`
- Intel-Microcode: `(new package) --> 20260812`
- IO-Tty: `(new package) --> 1.20`
- IPC-Run: `(new package) --> 20231003.0`
- ipp-usb: `(new package) --> 0.9.30`
- IPRoute2: `5.19.0 --> 7.1.0`
- iptables: `1.8.8 --> 1.8.13`
- iPXE: `(new package) --> 2.0.0`
- ISL: `(new package) --> 0.27`
- ISO-Codes: `4.11.0 --> 4.20.1`
- iw: `(new package) --> 6.17`
- JACK2: `1.9.21 --> 1.9.22`
- Jansson: `2.13.1 --> 2.15.1`
- JasPer: `3.0.6 --> 4.2.9`
...
- Less: `608 --> 704`
- libadwaita: `(new package) --> 1.9.3`
- libao: `(new package) --> 1.2.2`
- libaom: `(new package) --> 3.14.1`
- libappindicator: `(new package) --> 12.10.1`
- libarchive: `3.6.1 --> 3.8.9`
- libass: `0.16.0 --> 0.17.4`
- libassuan: `2.5.5 --> 3.0.2`
- libavif: `0.10.1 --> 1.4.2`
- libblockdev: `2.28 --> 3.5.0`
- libbluray: `1.3.3 --> 1.3.4`
- libbpf: `1.0.0 --> 1.6.2`
- libbsd: `(new package) --> 0.12.2`
- libburn: `1.5.4 --> 1.5.8`
- libbytesize: `2.7 --> 2.12`
- libcap: `2.66 --> 2.78`
- libcap-ng: `0.8.3 --> 0.8.5`
- libcbor: `0.9.0 --> 0.12.0`
- libcdio: `2.1.0 --> 2.2.0`
...
- libcupsfilters: `(new package) --> 2.2.0`
...
- libdisplay-info: `(new package) --> 0.4.0`
- libdmx: `1.1.4 --> 1.1.5`
- libdovi: `(new package) --> 2.3.1`
- libdrm: `2.4.113 --> 2.4.134`
- libdvdcss: `(new package) --> 1.6.0`
- libdvdnav: `6.1.1 --> 7.0.0`
- libdvdread: `6.1.3 --> 7.1.1`
- libedit: `20210910-3.1 --> 20250104-3.1`
- libevdev: `1.13.0 --> 1.13.6`
- libevent: `2.1.12 --> 2.1.13`
- libexif: `0.6.23 --> 0.6.26`
- libffi: `3.4.3 --> 3.7.1`
- libfido2: `1.12.0 --> 1.17.0`
- libfontenc: `1.1.6 --> 1.1.9`
- libfreeaptx: `(new package) --> 0.2.2`
- libFS: `1.0.9 --> 1.0.10`
- libftdi: `(new package) --> 1.5`
- libfyaml: `(new package) --> 0.9.6`
- libgcrypt: `1.10.1 --> 1.12.2`
- libgee: `0.20.6 --> 0.20.8`
- libglade: `2.6.4 --> (removed)`
- libglvnd: `1.5.0 --> 1.7.0`
- libgpg-error: `1.45 --> 1.61`
- libgphoto2: `2.5.30 --> 2.5.31`
- libgudev: `237 --> 238`
- libgusb: `0.4.0 --> 0.4.9`
- libhandy: `1.8.0 --> 1.8.3`
- libheif: `1.13.0 --> 1.23.0`
- libical: `3.0.14 --> 4.0.4`
- libICE: `1.0.10 --> 1.1.2`
- libidn2: `2.3.3 --> 2.3.8`
...
- libinput: `1.21.0 --> 1.31.3`
- libisoburn: `1.5.4 --> 1.5.8.pl02`
- libisofs: `1.5.4 --> 1.5.8.pl02`
- libjcat: `0.1.11 --> 0.2.3`
- libjpeg-turbo: `2.1.3 --> 3.2.0`
- libjxl: `(new package) --> 0.12.0`
- libksba: `1.6.1 --> 1.8.0`
- liblc3: `(new package) --> 1.1.3`
- libldap: `2.6.3 --> 2.7.0`
- libmanette: `(new package) --> 0.2.11`
- libmbim: `1.26.4 --> 1.34.0`
...
- libsysprof-capture: `3.46.0 --> 50.0`
...
- libtool: `2.4.7 --> 2.6.2`
- libtpms: `0.9.2 --> 0.10.2`
- libudfread: `(new package) --> 1.1.2`
- libunistring: `1.0 --> 1.4.2`
- libunwind: `1.6.2 --> 1.8.3`
- liburing: `2.1 --> 2.9`
- libusb: `1.0.26 --> 1.0.30`
- libusbmuxd: `2.0.2 --> 2.1.0`
- libuv: `1.44.2 --> 1.52.1`
- libva: `2.16.0 --> 2.24.1`
- libvpx: `1.12.0 --> 1.16.0`
- libwacom: `2.4.0 --> 2.19.1`
- libwbclient: `(new package) --> 4.23.3`
- libwebp: `1.2.5 --> 1.6.0`
- libwnck: `43.0 --> 43.3`
...
- libxcb: `1.15 --> 1.17`
- libXcomposite: `0.4.5 --> 0.4.7`
- libxcrypt: `(new package) --> 4.5.2`
- libXcursor: `1.2.1 --> 1.2.3`
- libxcvt: `0.1.2 --> 0.1.3`
- libXdamage: `1.4.5 --> 1.4.7`
- libXdmcp: `1.1.3 --> 1.1.5`
- libXext: `1.3.4 --> 1.3.7`
- libXfixes: `6.0.0 --> 6.0.2`
- libXfont2: `2.0.6 --> 2.0.9`
- libXft: `2.3.6 --> 2.3.8`
- libxkbcommon: `1.4.1 --> 1.13.2`
- libxkbfile: `1.1.0 --> 1.2.0`
- libXi: `1.8 --> 1.8.3`
- libXinerama: `1.1.4 --> 1.1.6`
- libxml2: `2.9.14 --> 2.15.3`
- libxmlb: `0.3.6 --> 0.3.29`
- libXmu: `1.1.3 --> 1.3.1`
- libXpm: `3.5.13 --> 3.5.19`
- libXpresent: `(new package) --> 1.0.2`
- libXrandr: `1.5.2 --> 1.5.5`
- libXrender: `0.9.10 --> 0.9.12`
- libXres: `1.2.1 --> 1.2.3`
- libXScrnSaver: `1.2.3 --> 1.2.5`
- libxshmfence: `1.3 --> 1.3.3`
- libxslt: `1.1.37 --> 1.1.45`
- libXt: `1.2.1 --> 1.3.1`
- libXtst: `1.2.4 --> 1.2.5`
- libXv: `1.0.11 --> 1.0.13`
- libXvMC: `1.0.13 --> 1.0.15`
- libXxf86dga: `1.1.5 --> 1.1.7`
...
- mpg123: `1.30.1 --> 1.33.7`
- msgraph: `(new package) --> 0.3.3`
- mtdev: `1.1.6 --> 1.1.7`
- mtools: `4.0.40 --> 4.0.49`
- multipath-tools: `(new package) --> 0.14.3`
- Nano: `6.4 --> 9.2`
- NASM: `2.15.05 --> 3.02`
- Ncurses: `6.3 --> 6.6`
...
- noto-fonts: `20220920 --> 2026.07.01`
- noto-fonts-cjk: `20220920 --> 20240730`
- noto-fonts-emoji: `20220920 --> 2.051`
- npth: `1.6 --> 1.8`
- NSPR: `4.35 --> 4.40`
- NSS: `3.83 --> 3.126`
...
- ostree: `2022.5 --> 2026.1`
- p11-kit: `0.24.1 --> 0.26.5`
- p7zip: `17.04 --> (removed)`
- packaging: `21.3 --> 26.3`
- Pahole: `1.24 --> 1.29`
- Pango: `1.50.11 --> 1.58.2`
- Pangomm: `2.46.3 --> 2.46.4`
- parallel: `(new package) --> 20250322`
- parted: `3.5 --> 3.7`
- passim: `(new package) --> 0.1.11`
- patch: `2.7.6 --> 2.8`
- patchelf: `0.14.5 --> 0.19.1`
- pathspec: `(new package) --> 1.1.1`
- pcaudiolib: `(new package) --> 1.3`
- pciutils: `3.8.0 --> 3.15.0`
- PCRE: `8.45 --> (removed)`
- PCRE2: `10.40 --> 10.47`
- pdfio: `(new package) --> 1.6.4`
- pefile: `(new package) --> 2024.8.26`
- Perl: `5.36.0 --> 5.42.2`
- pexpect: `4.8.0 --> 4.9`
- pkcs11-helper: `1.29.0 --> 1.31.0`
- pkg-config: `0.29.2 --> (removed)`
- pkgconf: `(new package) --> 3.0.5`
- pigz: `2.6 --> 2.8`
- pinentry: `1.2.1 --> 1.3.3`
- pip: `(new package) --> 26.2.1`
- PipeWire: `0.3.59 --> 1.6.8`
- Pixman: `0.40.0 --> 0.46.4`
- pluggy: `(new package) --> 1.6.0`
- Plymouth: `22.02.122 --> 24.004.60-149-g4a3c171d`
- poetry-core: `(new package) --> 2.1.2`
- Polkit: `121 --> 127`
- Poppler: `22.09.0 --> 26.08.0`
...
- pv: `1.6.20 --> 1.9.31`
- PyCairo: `1.21.0 --> 1.29.1`
- pycparser: `2.21 --> 2.23`
- pycups: `(new package) --> 2.0.4`
- pyelftools: `(new package) --> 0.32`
- Pygments: `2.13.0 --> 2.20.0`
- PyGObject: `3.42.2 --> 3.56.3`
- pyopenssl: `22.1.0 --> 25.0.0`
- PyParsing: `3.0.7 --> 3.3.2`
- pyproject-hooks: `(new package) --> 1.2.0`
- pyproject-metadata: `(new package) --> 0.11.0`
- Python: `3.10.7 --> 3.14.7`
- python-certifi: `2022.06.15 --> 2026.06.17`
- python-dbusmock: `0.28.4 --> 0.38.1`
...
- SANE: `1.1.1 --> 1.4.0`
- sane-airscan: `(new package) --> 0.99.36`
- SBC: `2.0 --> 2.2`
- sbsigntools: `(new package) --> 0.9.5`
- scdoc: `(new package) --> 1.11.0`
- SDL: `1.2.15 --> (removed)`
- sdl12-compat: `(new package) --> 1.2.76`
- SDL2: `2.24.0 --> (removed)`
- sdl2-compat: `(new package) --> 2.32.70`
- SDL3: `(new package) --> 3.4.14`
- seatd: `(new package) --> 0.9.1`
- Sed: `4.8 --> 4.10`
- semantic-version: `(new package) --> 2.10.0`
- sessreg: `1.1.2 --> 1.1.4`
- setuptools: `69.0.2 --> 83.0.0`
- setuptools-rust: `(new package) --> 1.12.1`
- setuptools-scm: `(new package) --> 10.1.2`
- setxkbmap: `1.3.3 --> 1.3.4`
- shaderc: `(new package) --> 2026.3`
- Shadow: `4.12.3 --> 4.19.4`
- shared-mime-info: `2.2 --> 2.5.1`
- shim: `(new package) --> 16.1`
- simdutf: `(new package) --> 9.0.0`
- six: `1.16.0 --> 1.17.0`
- sl: `5.02 --> 5.05`
- smartmontools: `(new package) --> 7.5`
- smartypants: `2.0.1 --> 2.0.2`
- smbclient: `4.19.3 --> 4.23.3`
- smproxy: `1.0.6 --> 1.0.8`
- sndio: `(new package) --> 1.10.0`
- SOF-Firmware: `(new package) --> 2025.12.2`
- SoundTouch: `2.3.1 --> 2.4.1`
...
- usbutils: `014 --> 019`
- Userspace-RCU: `0.13.2 --> 0.15.6`
- utfcpp: `(new package) --> 4.1.1`
- util-linux: `2.38.1 --> 2.42.2`
- util-macros: `1.19.3 --> 1.20.2`
- Vala: `0.56.3 --> 0.56.19`
- Vim: `9.0.0600 --> 9.2.0782`
- virglrenderer: `(new package) --> 1.2.0`
- virtiofsd: `(new package) --> 1.13.1`
- VTE: `0.70.0 --> 0.84.1`
- VTE4: `(new package) --> 0.84.1`
- Vulkan-Headers: `1.3.230 --> 1.4.357.0`
- Vulkan-Loader: `1.3.230 --> 1.4.357.0`
- Vulkan-Tools: `1.3.230 --> 1.4.357.0`
- wavpack: `5.5.0 --> 5.8.1`
- Wayland: `1.21.0 --> 1.26.0`
- wayland-protocols: `1.26 --> 1.49`
- WebKitGTK: `2.38.0 --> 2.52.5`
- webp-pixbuf-loader: `0.0.6 --> (removed)`
- Wget: `1.21.3 --> 1.25.0`
- wheel: `(new package) --> 0.47.0`
- Which: `2.21 --> 2.25`
- whois: `5.5.13 --> 5.6.6`
- WirePlumber: `0.4.12 --> 0.5.15`
- wlroots: `(new package) --> 0.20.2`
- wlr-protocols: `(new package) --> 107`
- wpa-supplicant: `2.10 --> 2.12`
- wpebackend-fdo: `1.14.0 --> 1.16.0`
- x11perf: `1.6.1 --> 1.7.0`
- x264: `0.164.3099 --> 0.165.3223`
- x265: `3.5-40-g931178347 --> 4.2`
- xauth: `1.1.2 --> 1.1.5`
- xbacklight: `1.2.3 --> 1.2.4`
- xbitmaps: `1.1.2 --> 1.1.4`
...
- xdg-dbus-proxy: `0.1.4 --> 0.1.8`
- xdg-desktop-portal: `1.14.6 --> 1.22.1`
- xdg-desktop-portal-gtk: `1.14.0 --> 1.15.3`
- xdg-desktop-portal-wlr: `(new package) --> 0.8.3`
- xdg-user-dirs: `0.18 --> 0.20`
- xdpyinfo: `1.3.3 --> 1.4.0`
...
- xkbcomp: `1.4.5 --> 1.5.0`
- xkbevd: `1.1.4 --> 1.1.6`
- xkbutils: `1.0.5 --> 1.0.7`
- xkeyboard-config: `2.36 --> 2.48`
- xkill: `1.0.5 --> 1.0.7`
- xlsatoms: `1.1.3 --> 1.1.5`
- xlsclients: `1.1.4 --> 1.1.6`
- xmessage: `1.0.6 --> 1.0.7`
- XML-Parser: `2.46 --> 2.59`
- xmlsec: `(new package) --> 1.3.11`
- xmlto: `0.0.28 --> 0.0.29`
- xmodmap: `1.0.11 --> 1.0.12`
- Xorg-Server: `21.1.4 --> 21.1.24`
- xorgproto: `2022.2 --> 2025.1`
- xpr: `1.1.0 --> 1.2.0`
- xprop: `1.2.5 --> 1.2.8`
- xrandr: `1.5.1 --> 1.5.4`
- xrdb: `1.2.1 --> 1.2.3`
- xrefresh: `1.0.7 --> 1.1.1`
- xset: `1.2.4 --> 1.2.6`
- xsetroot: `1.1.2 --> 1.1.4`
- xtrans: `1.4.0 --> 1.6.0`
- xvinfo: `1.1.4 --> 1.1.6`
- Xwayland: `22.1.3 --> 24.1.13`
- xwd: `1.0.8 --> 1.0.10`
- xwininfo: `1.1.5 --> 1.1.7`
- xwud: `1.0.6 --> 1.0.8`
- xxhash: `0.8.1 --> 0.8.3`
- xz: `5.2.7 --> 5.8.2`
